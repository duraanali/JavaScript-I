...
const carMake = inventory[32].car_make;
const carYear = inventory[32].car_year;
const carModel = inventory[32].car_model;
...
console.log('The last Car is ' + lastCarMake + ' ' + lastCarModel + ' ');
